...
class trade:
    ...
    def standarding(self,
                    scaler_method : Literal['MinMax', 'Standard'],
                    scaler_addrs,
                    value_1_addrs,
                    value_2_addrs,
                    array):
        ...
        scaler = joblib.load(scaler_addrs)
        data_1 = np.load(value_1_addrs)
        data_2 = np.load(value_2_addrs)
        match scaler_method:
            case "Standard":
                scaler.mean_ = data_1
                scaler.scale_ = data_2
            case "MinMax":
                scaler.data_max_ = data_1
                scaler.data_min_ = data_2
